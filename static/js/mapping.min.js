...
{addEventListener:function(a,b,d){if(c.Util.invokeEach(a,this.addEventListener,this,b,d))return this;var e,f,g,l,n,h,k,m=this._leaflet_events=this._leaflet_events||{},p=d&&d!==this&&c.stamp(d);a=c.Util.splitWords(a);e=0;for(f=a.length;f>e;e++)g={action:b,context:d||this},l=a[e],p?(n=l+"_idx",h=n+"_len",k=m[n]=m[n]||{},k[p]||(k[p]=[],m[h]=(m[h]||0)+1),k[p].push(g)):(m[l]=m[l]||[],m[l].push(g));return this},hasEventListeners:function(a){var b=this._leaflet_events;return!!b&&(a in b&&0<b[a].length||
a+"_idx"in b&&0<b[a+"_idx_len"])},removeEventListener:function(a,b,d){if(!this._leaflet_events)return this;if(!a)return this.clearAllEventListeners();if(c.Util.invokeEach(a,this.removeEventListener,this,b,d))return this;var e,f,g,l,n,h,k,m,p,r=this._leaflet_events,u=d&&d!==this&&c.stamp(d);a=c.Util.splitWords(a);e=0;for(f=a.length;f>e;e++)if(g=a[e],h=g+"_idx",k=h+"_len",m=r[h],b){if(l=u&&m?m[u]:r[g]){for(n=l.length-1;0<=n;n--)l[n].action!==b||d&&l[n].context!==d||(p=l.splice(n,1),p[0].action=c.Util.falseFn);
d&&m&&0===l.length&&(delete m[u],r[k]--)}}else delete r[g],delete r[h],delete r[k];return this},clearAllEventListeners:function(){return delete this._leaflet_events,this},fireEvent:function(a,b){if(!this.hasEventListeners(a))return this;var d,e,f,g,l,n=c.Util.extend({},b,{type:a,target:this});g=this._leaflet_events;if(g[a])for(d=g[a].slice(),e=0,f=d.length;f>e;e++)d[e].action.call(d[e].context,n);g=g[a+"_idx"];for(l in g)if(d=g[l].slice())for(e=0,f=d.length;f>e;e++)d[e].action.call(d[e].context,n);
...
k&&k.matchMedia("(min-resolution:144dpi)")&&k.matchMedia("(min-resolution:144dpi)").matches,r=h.documentElement,u=a&&"transition"in r.style,w="WebKitCSSMatrix"in k&&"m11"in new k.WebKitCSSMatrix&&!n,q="MozPerspective"in r.style,t="OTransition"in r.style,z=!k.L_DISABLE_3D&&(u||w||q||t)&&!g;if(g=!k.L_NO_TOUCH&&!g)y||"ontouchstart"in r?g=!0:(g=h.createElement("div"),r=!1,g=g.setAttribute?(g.setAttribute("ontouchstart","return;"),"function"==typeof g.ontouchstart&&(r=!0),g.removeAttribute("ontouchstart"),
r):!1);c.Browser={ie:a,ielt9:b,webkit:e,gecko:d&&!e&&!k.opera&&!a,android:l,android23:n,chrome:f,ie3d:u,webkit3d:w,gecko3d:q,opera3d:t,any3d:z,mobile:v,mobileWebkit:v&&e,mobileWebkit3d:v&&w,mobileOpera:v&&k.opera,touch:g,msPointer:x,pointer:y,retina:p}})();c.Point=function(a,b,c){this.x=c?Math.round(a):a;this.y=c?Math.round(b):b};c.Point.prototype={clone:function(){return new c.Point(this.x,this.y)},add:function(a){return this.clone()._add(c.point(a))},_add:function(a){return this.x+=a.x,this.y+=
...
initialize:function(a,b){b=c.setOptions(this,b);this._initContainer(a);this._initLayout();this._onResize=c.bind(this._onResize,this);this._initEvents();b.maxBounds&&this.setMaxBounds(b.maxBounds);b.center&&b.zoom!==m&&this.setView(c.latLng(b.center),b.zoom,{reset:!0});this._handlers=[];this._layers={};this._zoomBoundLayers={};this._tileLayersNum=0;this.callInitHooks();this._addLayers(b.layers)},setView:function(a,b){return b=b===m?this.getZoom():b,this._resetView(c.latLng(a),this._limitZoom(b)),this},
...
getBounds:function(){var a=this.getPixelBounds(),b=this.unproject(a.getBottomLeft()),a=this.unproject(a.getTopRight());return new c.LatLngBounds(b,a)},getMinZoom:function(){return this.options.minZoom===m?this._layersMinZoom===m?0:this._layersMinZoom:this.options.minZoom},getMaxZoom:function(){return this.options.maxZoom===m?this._layersMaxZoom===m?1/0:this._layersMaxZoom:this.options.maxZoom},getBoundsZoom:function(a,b,d){a=c.latLngBounds(a);var e,f=this.getMinZoom()-(b?1:0),g=this.getMaxZoom(),
l=this.getSize(),n=a.getNorthWest();a=a.getSouthEast();e=!0;d=c.point(d||[0,0]);do f++,e=this.project(a,f).subtract(this.project(n,f)).add(d),e=b?e.x<l.x||e.y<l.y:l.contains(e);while(e&&g>=f);return e&&b?null:b?f:f-1},getSize:function(){return(!this._size||this._sizeChanged)&&(this._size=new c.Point(this._container.clientWidth,this._container.clientHeight),this._sizeChanged=!1),this._size.clone()},getPixelBounds:function(){var a=this._getTopLeftPoint();return new c.Bounds(a,a.add(this.getSize()))},
getPixelOrigin:function(){return this._checkIfLoaded(),this._initialTopLeftPoint},getPanes:function(){return this._panes},getContainer:function(){return this._container},getZoomScale:function(a){var b=this.options.crs;return b.scale(a)/b.scale(this._zoom)},getScaleZoom:function(a){return this._zoom+Math.log(a)/Math.LN2},project:function(a,b){return b=b===m?this._zoom:b,this.options.crs.latLngToPoint(c.latLng(a),b)},unproject:function(a,b){return b=b===m?this._zoom:b,this.options.crs.pointToLatLng(c.point(a),
...
_updateZoomLevels:function(){var a,b=1/0,c=-1/0,e=this._getZoomSpan();for(a in this._zoomBoundLayers){var f=this._zoomBoundLayers[a];isNaN(f.options.minZoom)||(b=Math.min(b,f.options.minZoom));isNaN(f.options.maxZoom)||(c=Math.max(c,f.options.maxZoom))}a===m?this._layersMaxZoom=this._layersMinZoom=m:(this._layersMaxZoom=c,this._layersMinZoom=b);e!==this._getZoomSpan()&&this.fire("zoomlevelschange")},_panInsideMaxBounds:function(){this.panInsideBounds(this.options.maxBounds)},_checkIfLoaded:function(){if(!this._loaded)throw Error("Set map center and zoom first.");
...
c.DomUtil.create("img","leaflet-tile");return a.style.width=a.style.height=this._getTileSize()+"px",a.galleryimg="no",a.onselectstart=a.onmousemove=c.Util.falseFn,c.Browser.ielt9&&this.options.opacity!==m&&c.DomUtil.setOpacity(a,this.options.opacity),c.Browser.mobileWebkit3d&&(a.style.WebkitBackfaceVisibility="hidden"),a},_loadTile:function(a,b){a._layer=this;a.onload=this._tileOnLoad;a.onerror=this._tileOnError;this._adjustTilePoint(b);a.src=this.getTileUrl(b);this.fire("tileloadstart",{tile:a,url:a.src})},
...
g=c.point(this.options.autoPanPaddingTopLeft||f),f=c.point(this.options.autoPanPaddingBottomRight||f),l=a.getSize(),n=0,h=0;e.x+d+f.x>l.x&&(n=e.x+d-l.x+f.x);0>e.x-n-g.x&&(n=e.x-g.x);e.y+b+f.y>l.y&&(h=e.y+b-l.y+f.y);0>e.y-h-g.y&&(h=e.y-g.y);(n||h)&&a.fire("autopanstart").panBy([n,h])}},_onCloseButtonClick:function(a){this._close();c.DomEvent.stop(a)}});c.popup=function(a,b){return new c.Popup(a,b)};c.Map.include({openPopup:function(a,b,d){(this.closePopup(),a instanceof c.Popup)||(a=(new c.Popup(d)).setLatLng(b).setContent(a));
...
b*b;return a=this._reducePoints(a,c),this._simplifyDP(a,c)},pointToSegmentDistance:function(a,b,c){return Math.sqrt(this._sqClosestPointOnSegment(a,b,c,!0))},closestPointOnSegment:function(a,b,c){return this._sqClosestPointOnSegment(a,b,c)},_simplifyDP:function(a,b){var c=a.length,e=new (typeof Uint8Array!=m+""?Uint8Array:Array)(c);e[0]=e[c-1]=1;this._simplifyDPStep(a,e,b,0,c-1);var f,g=[];for(f=0;c>f;f++)e[f]&&g.push(a[f]);return g},_simplifyDPStep:function(a,b,c,e,f){var g,l,h,k=0;for(l=e+1;f-1>=
l;l++)h=this._sqClosestPointOnSegment(a[l],a[e],a[f],!0),h>k&&(g=l,k=h);k>c&&(b[g]=1,this._simplifyDPStep(a,b,c,e,g),this._simplifyDPStep(a,b,c,g,f))},_reducePoints:function(a,b){for(var c=[a[0]],e=1,f=0,g=a.length;g>e;e++)this._sqDist(a[e],a[f])>b&&(c.push(a[e]),f=e);return g-1>f&&c.push(a[g-1]),c},clipSegment:function(a,b,c,e){var f,g,l=e?this._lastCode:this._getBitCode(a,c),h=this._getBitCode(b,c);for(this._lastCode=h;;){if(!(l|h))return[a,b];if(l&h)return!1;e=l||h;f=this._getEdgeIntersection(a,
b,e,c);g=this._getBitCode(f,c);e===l?(a=f,l=g):(b=f,h=g)}},_getEdgeIntersection:function(a,b,d,e){var f=b.x-a.x;b=b.y-a.y;var g=e.min;e=e.max;return 8&d?new c.Point(a.x+f*(e.y-a.y)/b,e.y):4&d?new c.Point(a.x+f*(g.y-a.y)/b,g.y):2&d?new c.Point(e.x,a.y+b*(e.x-a.x)/f):1&d?new c.Point(g.x,a.y+b*(g.x-a.x)/f):void 0},_getBitCode:function(a,b){var c=0;return a.x<b.min.x?c|=1:a.x>b.max.x&&(c|=2),a.y<b.min.y?c|=4:a.y>b.max.y&&(c|=8),c},_sqDist:function(a,b){var c=b.x-a.x,e=b.y-a.y;return c*c+e*e},_sqClosestPointOnSegment:function(a,
b,d,e){var f,g=b.x;b=b.y;var l=d.x-g,h=d.y-b,k=l*l+h*h;return 0<k&&(f=((a.x-g)*l+(a.y-b)*h)/k,1<f?(g=d.x,b=d.y):0<f&&(g+=l*f,b+=h*f)),l=a.x-g,h=a.y-b,e?l*l+h*h:new c.Point(g,b)}};c.Polyline=c.Path.extend({initialize:function(a,b){c.Path.prototype.initialize.call(this,b);this._latlngs=this._convertLatLngs(a)},options:{smoothFactor:1,noClip:!1},projectLatlngs:function(){this._originalPoints=[];for(var a=0,b=this._latlngs.length;b>a;a++)this._originalPoints[a]=this._map.latLngToLayerPoint(this._latlngs[a])},
...
e=1/0,f=this._parts,g=null,l=0,h=f.length;h>l;l++)for(var k=f[l],m=1,q=k.length;q>m;m++){b=k[m-1];d=k[m];var p=c.LineUtil._sqClosestPointOnSegment(a,b,d,!0);e>p&&(e=p,g=c.LineUtil._sqClosestPointOnSegment(a,b,d))}return g&&(g.distance=Math.sqrt(e)),g},getBounds:function(){return new c.LatLngBounds(this.getLatLngs())},_convertLatLngs:function(a,b){var d,e,f=b?a:[];d=0;for(e=a.length;e>d;d++){if(c.Util.isArray(a[d])&&"number"!=typeof a[d][0])return;f[d]=c.latLng(a[d])}return f},_initEvents:function(){c.Path.prototype._initEvents.call(this)},
_getPathPartStr:function(a){for(var b,d=c.Path.VML,e=0,f=a.length,g="";f>e;e++)b=a[e],d&&b._round(),g+=(e?"L":"M")+b.x+" "+b.y;return g},_clipPoints:function(){var a,b,d,e=this._originalPoints,f=e.length;if(this.options.noClip)return void(this._parts=[e]);var g=this._parts=[],l=this._map._pathViewport,h=c.LineUtil;for(b=a=0;f-1>a;a++)(d=h.clipSegment(e[a],e[a+1],l,a))&&(g[b]=g[b]||[],g[b].push(d[0]),(d[1]!==e[a+1]||a===f-2)&&(g[b].push(d[1]),b++))},_simplifyPoints:function(){for(var a=this._parts,
b=c.LineUtil,d=0,e=a.length;e>d;d++)a[d]=b.simplify(a[d],this.options.smoothFactor)},_updatePath:function(){this._map&&(this._clipPoints(),this._simplifyPoints(),c.Path.prototype._updatePath.call(this))}});c.polyline=function(a,b){return new c.Polyline(a,b)};c.PolyUtil={};c.PolyUtil.clipPolygon=function(a,b){var d,e,f,g,l,h,k,m,q=[1,4,2,8],p=c.LineUtil;e=0;for(h=a.length;h>e;e++)a[e]._code=p._getBitCode(a[e],b);for(g=0;4>g;g++){k=q[g];d=[];e=0;h=a.length;for(f=h-1;h>e;f=e++)l=a[e],f=a[f],l._code&
k?f._code&k||(m=p._getEdgeIntersection(f,l,k,b),m._code=p._getBitCode(m,b),d.push(m)):(f._code&k&&(m=p._getEdgeIntersection(f,l,k,b),m._code=p._getBitCode(m,b),d.push(m)),d.push(l));a=d}return a};c.Polygon=c.Polyline.extend({options:{fill:!0},initialize:function(a,b){c.Polyline.prototype.initialize.call(this,a,b);this._initWithHoles(a)},_initWithHoles:function(a){var b,d;if(a&&c.Util.isArray(a[0])&&"number"!=typeof a[0][0])for(this._latlngs=this._convertLatLngs(a[0]),this._holes=a.slice(1),a=0,b=
...
b)};c.Polyline.include(c.Path.CANVAS?{_containsPoint:function(a,b){var d,e,f,g,l,h,k,m=this.options.weight/2;c.Browser.touch&&(m+=10);d=0;for(g=this._parts.length;g>d;d++)for(k=this._parts[d],e=0,l=k.length,f=l-1;l>e;f=e++)if((b||0!==e)&&(h=c.LineUtil.pointToSegmentDistance(a,k[f],k[e]),m>=h))return!0;return!1}}:{});c.Polygon.include(c.Path.CANVAS?{_containsPoint:function(a){var b,d,e,f,g,l,h,k=!1;if(c.Polyline.prototype._containsPoint.call(this,a,!0))return!0;f=0;for(l=this._parts.length;l>f;f++)for(b=
...
e.onEachFeature(a,b),this.addLayer(b)},resetStyle:function(a){var b=this.options.style;b&&(c.Util.extend(a.options,a.defaultOptions),this._setLayerStyle(a,b))},setStyle:function(a){this.eachLayer(function(b){this._setLayerStyle(b,a)},this)},_setLayerStyle:function(a,b){"function"==typeof b&&(b=b(a.feature));a.setStyle&&a.setStyle(b)}});c.extend(c.GeoJSON,{geometryToLayer:function(a,b,d,e){var f,g,l,h="Feature"===a.type?a.geometry:a,k=h.coordinates,m=[];switch(d=d||this.coordsToLatLng,h.type){case "Point":return f=
d(k),b?b(a,f):new c.Marker(f);case "MultiPoint":g=0;for(l=k.length;l>g;g++)f=d(k[g]),m.push(b?b(a,f):new c.Marker(f));return new c.FeatureGroup(m);case "LineString":return g=this.coordsToLatLngs(k,0,d),new c.Polyline(g,e);case "Polygon":if(2===k.length&&!k[1].length)throw Error("Invalid GeoJSON object.");return g=this.coordsToLatLngs(k,1,d),new c.Polygon(g,e);case "MultiLineString":return g=this.coordsToLatLngs(k,1,d),new c.MultiPolyline(g,e);case "MultiPolygon":return g=this.coordsToLatLngs(k,2,
d),new c.MultiPolygon(g,e);case "GeometryCollection":g=0;for(l=h.geometries.length;l>g;g++)m.push(this.geometryToLayer({geometry:h.geometries[g],type:"Feature",properties:a.properties},b,d,e));return new c.FeatureGroup(m);default:throw Error("Invalid GeoJSON object.");}},coordsToLatLng:function(a){return new c.LatLng(a[1],a[0],a[2])},coordsToLatLngs:function(a,b,c){var e,f,g,h=[];f=0;for(g=a.length;g>f;f++)e=b?this.coordsToLatLngs(a[f],b-1,c):(c||this.coordsToLatLng)(a[f]),h.push(e);return h},latLngToCoords:function(a){var b=
[a.lng,a.lat];return a.alt!==m&&b.push(a.alt),b},latLngsToCoords:function(a){for(var b=[],d=0,e=a.length;e>d;d++)b.push(c.GeoJSON.latLngToCoords(a[d]));return b},getFeature:function(a,b){return a.feature?c.extend({},a.feature,{geometry:b}):c.GeoJSON.asFeature(b)},asFeature:function(a){return"Feature"===a.type?a:{type:"Feature",properties:{},geometry:a}}});var t={toGeoJSON:function(){return c.GeoJSON.getFeature(this,{type:"Point",coordinates:c.GeoJSON.latLngToCoords(this.getLatLng())})}};c.Marker.include(t);
...
"pointerup":"touchend",addDoubleTapListener:function(a,b,d){function e(a){var b;if(c.Browser.pointer?(p.push(a.pointerId),b=p.length):b=a.touches.length,!(1<b)){b=Date.now();var d=b-(g||b);l=a.touches?a.touches[0]:a;k=0<d&&m>=d;g=b}}function f(a){if(c.Browser.pointer){a=p.indexOf(a.pointerId);if(-1===a)return;p.splice(a,1)}if(k){if(c.Browser.pointer){var d={},e;for(e in l)a=l[e],d[e]="function"==typeof a?a.bind(l):a;l=d}l.type="dblclick";b(l);g=null}}var g,l,k=!1,m=250,q=this._touchstart,t=this._touchend,
p=[];a["_leaflet_"+q+d]=e;a["_leaflet_"+t+d]=f;d=c.Browser.pointer?h.documentElement:a;return a.addEventListener(q,e,!1),d.addEventListener(t,f,!1),c.Browser.pointer&&d.addEventListener(c.DomEvent.POINTER_CANCEL,f,!1),this},removeDoubleTapListener:function(a,b){return a.removeEventListener(this._touchstart,a["_leaflet_"+this._touchstart+b],!1),(c.Browser.pointer?h.documentElement:a).removeEventListener(this._touchend,a["_leaflet_"+this._touchend+b],!1),c.Browser.pointer&&h.documentElement.removeEventListener(c.DomEvent.POINTER_CANCEL,
...
function get_map_data(k){var h=k.getBounds(),m=h.getSouthWest().wrap(),h=h.getNorthEast().wrap(),q=Math.floor(Math.min($(document).height(),$(document).width())/100),m=Math.min(h.lng-m.lng,h.lat-m.lat)/q,h=["/map_points/"];h.push(m);h.push("/");$.get(h.join(""),function(c){for(e=0;e<markers.length;e++)k.removeLayer(markers[e]);markers.length=0;for(var h in c){var a=c[h],b=L.divIcon({className:"circle",iconSize:[40,40],iconAnchor:[20,20],popupAnchor:[0,-5],html:a.length}),b=L.marker([a[0].latitude,
...
m.addControl(L.control.zoom({position:"bottomleft"}));var q=L.divIcon({className:"circle",iconSize:[20,20],iconAnchor:[10,10],popupAnchor:[0,-5],html:""});L.marker([k,h],{icon:q}).addTo(m)};
