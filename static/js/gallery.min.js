...
html.push(' data-title="');html.push("&lt;a href='/image=");html.push(data[i].pk);html.push("/details/' class='btn btn-info' &gt; ");html.push(details_translation);html.push(" &lt;/a&gt ");html.push(data[i].fields.title);html.push('">');html.push('<img class="masonry_thumbnail" src="/media/'+data[i].fields.thumbnail+'" ');html.push('alt="'+data[i].fields.title+'/"');html.push("/>");html.push("</a>")}$("div#loadmoreajaxloader").hide();var $data=$(html.join(""));var $container=$("#image_container");
$container.append($data).imagesLoaded(function(){$container.masonry("appended",$data.filter(".image_in_gallery"),true);gallery_loading=false;if($container.height()<$(window).height())gallery_load_more()})}else{$("#NoMoreImages").show();$("div#loadmoreajaxloader").hide()}},error:function(jqXHR,textStatus,errorThrown){$("#ErrorLoadingImages").show();$("div#loadmoreajaxloader").hide();gallery_loading=false}})};
