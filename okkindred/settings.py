...
FACE_RECOG_MESSAGE_CHECK_INTERVAL_SECONDS = 10
FACE_RECOG_RESIZE_TAG_TEMP_DIR = secrets.FACE_RECOG_RESIZE_TAG_TEMP_DIR
FACE_RECOG_RESIZE_ALL_HISTORICAL_TAGS_TEMP_DIR = secrets.FACE_RECOG_RESIZE_ALL_HISTORICAL_TAGS_TEMP_DIR
FACE_RECOG_IMAGE_FACE_DETECT_TEMP_DIR = secrets.FACE_RECOG_IMAGE_FACE_DETECT_TEMP_DIR
FACE_RECOG_TRAIN_FACE_RECOGNITION_TEMP_DIR = secrets.FACE_RECOG_TRAIN_FACE_RECOGNITION_TEMP_DIR

FACE_RECOG_RESIZE_TAG_TEST_DIR = secrets.FACE_RECOG_RESIZE_TAG_TEST_DIR
FACE_RECOG_RESIZE_ALL_HISTORICAL_TAGS_TEST_DIR = secrets.FACE_RECOG_RESIZE_ALL_HISTORICAL_TAGS_TEST_DIR
FACE_RECOG_IMAGE_FACE_DETECT_TEST_DIR = secrets.FACE_RECOG_IMAGE_FACE_DETECT_TEST_DIR
FACE_RECOG_TRAIN_FACE_RECOGNITION_TEST_DIR = secrets.FACE_RECOG_TRAIN_FACE_RECOGNITION_TEST_DIR
